...
saveRDS(array_onedim, "array_onedim.rds")
onedimnames <- LETTERS[1:12]
array_onedim_named <- array(data=1:12, dim=c(12), dimnames=list(onedimnames)) 
saveRDS(array_onedim_named, "array_onedim_named.rds")
